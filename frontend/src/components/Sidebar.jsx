...
function Sidebar({ onClose }) {
  ...
  const allMenuItems = [
    ...
    { name: 'Prescriptions', path: '/prescriptions', icon: FileText, roles: ['staff', 'customer'] },
    { name: user?.role === 'delivery_store' ? 'Delivery Tasks' : 'Orders', path: '/orders', icon: Truck, roles: ['admin', 'staff', 'delivery_store', 'customer'] },
    { name: 'Admin Tracking', path: '/admin/tracking', icon: Truck, roles: ['admin', 'staff'] },
    ...
    { name: user?.role === 'delivery_store' ? 'Restock Monitor' : 'Restock Requests', path: '/restock-requests', icon: ClipboardList, roles: ['admin', 'staff', 'delivery_store'] },
